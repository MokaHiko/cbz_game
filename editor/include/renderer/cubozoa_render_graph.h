...
typedef enum {
  ...
  // TODO: Keep track of free capture passes
  // Set Up passes
  RENDER_PASS_TYPE_CAPTURE_0,
  RENDER_PASS_TYPE_CAPTURE_1,
  RENDER_PASS_TYPE_CAPTURE_2,
  RENDER_PASS_TYPE_CAPTURE_3,
  RENDER_PASS_TYPE_CAPTURE_4,
  RENDER_PASS_TYPE_CAPTURE_5,
} RenderPassType;
